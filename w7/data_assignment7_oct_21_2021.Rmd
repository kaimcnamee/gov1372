...
preds_combined %>% 
  ggplot(aes(x = day_running)) +
    geom_path(aes(y = before)) +
    geom_path(aes(y = after)) +
    geom_vline(xintercept = 155, lty = "dashed") +
    labs(x = "Day running", y = "Police ufavorability") +
    theme_light() +
    labs(title = "Modelling treatment effect day after protests")
```
