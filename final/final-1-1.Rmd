...
```{r models}
m1 <- lm(asians ~ fox + cnn + party + date + tot_cases + new_case + tot_death + new_death + state + lockdown + search_coronavirus + search_china_virus, joined_data %>% drop_na(tot_cases))
summary(m1)
...
stargazer(m_totals, m_new, m_search, type = "text")
